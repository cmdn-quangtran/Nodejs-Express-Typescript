...
export const S3_BUCKET_NAME = "S3_BUCKET_NAME" as const;
export const S3_BUCKET_REGION = "S3_BUCKET_REGION" as const;
...
export const OBJECT_STORAGE = "OBJECT_STORAGE" as const;
...
export const UPLOAD_FILE_USE_CASE = "UPLOAD_FILE_USE_CASE" as const;
